...
public class train18 extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.train8, container, false);
        ...
        int startHour = -13;
        if (currentMinute > 49)              // if later then the minute, the minute takes place in the next hour
            currentHour++;
