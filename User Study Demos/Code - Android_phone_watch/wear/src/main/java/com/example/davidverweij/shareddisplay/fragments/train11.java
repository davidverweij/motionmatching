...
public class train11 extends Fragment {
    private View view;
    private TextView[] adjustables = new TextView[8];
    private TextView[] times = new TextView[8];
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.train1, container, false);
        ...
        int startHour = -13;
        if (currentMinute > 31)              // if later then the minute, the minute takes place in the next hour
            currentHour++;
